...
func (x *ProductID) GetValue() int32 {
	if x != nil {
		return x.Value
	}
	return 0
...
type Product struct {
	...
	Price      float64 `protobuf:"fixed64,6,opt,name=price,proto3" json:"price,omitempty"` //    string last = 7;
}
...
var file_proto_products_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x93,
	...
	0x0a, 0x08, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05,
