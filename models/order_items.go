...
var OrderItemTableColumns = struct {
	...
	ListPrice: "order_items.list_price",
...
var OrderItemWhere = struct {
	...
	ItemID:    whereHelperint{field: "\"order_items\".\"item_id\""},
	ProductID: whereHelperint{field: "\"order_items\".\"product_id\""},
	Quantity:  whereHelperint{field: "\"order_items\".\"quantity\""},
	ListPrice: whereHelpertypes_Decimal{field: "\"order_items\".\"list_price\""},
	Discount:  whereHelpertypes_Decimal{field: "\"order_items\".\"discount\""},
}
...
var (
	orderItemAllColumns            = []string{"order_id", "item_id", "product_id", "quantity", "list_price", "discount"}
	orderItemColumnsWithoutDefault = []string{"order_id", "item_id", "product_id", "quantity", "list_price"}
	orderItemColumnsWithDefault    = []string{"discount"}
	orderItemPrimaryKeyColumns     = []string{"order_id", "item_id"}
)
...
func (o *OrderItem) SetOrder(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Order) error {
	...
	values := []interface{}{related.OrderID, o.OrderID, o.ItemID}
...
func (o *OrderItem) SetProduct(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Product) error {
	...
	values := []interface{}{related.ProductID, o.OrderID, o.ItemID}
...
func FindOrderItem(ctx context.Context, exec boil.ContextExecutor, orderID int, itemID int, selectCols ...string) (*OrderItem, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"order_items\" where \"order_id\"=$1 AND \"item_id\"=$2", sel,
	)

	q := queries.Raw(query, orderID, itemID)
...
func (o *OrderItem) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"order_items\" WHERE \"order_id\"=$1 AND \"item_id\"=$2"
...
func (o *OrderItem) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindOrderItem(ctx, exec, o.OrderID, o.ItemID)
	if err != nil {
		return err
	}
...
func OrderItemExists(ctx context.Context, exec boil.ContextExecutor, orderID int, itemID int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"order_items\" where \"order_id\"=$1 AND \"item_id\"=$2 limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, orderID, itemID)
	}
	row := exec.QueryRowContext(ctx, sql, orderID, itemID)
